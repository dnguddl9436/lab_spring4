...
<script type="text/javascript">
	$(document).ready(function() {
		$('#dg_board').datagrid({
			columns:[[
				{field:'Room_Id',title:'방번호(hidden)',width:100,align:'center'},
				{field:'user',title:'상대방 닉네임',width:400,align:'left'},
				{field:'message',title:'마지막 메세지',width:150,align:'center'},
				{field:'timestamp',title:'보낸 시각',width:230,align:'center'},
			]]
		});
	});
</script>
